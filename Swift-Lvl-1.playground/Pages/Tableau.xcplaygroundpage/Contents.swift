...
var monArray: Array<String> // Ici `monArray` n'est pas instancié
//: Plus court: __la version la plus utilisée__
var shorter: [String] // `shorter` est vide
var monShorter = [String]() // Equivalent à `var someArray = Array<String>()`
...
shoppingList += ["Chocolate Spread", "Cheese", "Butter"] // Non optimisé pour un élément
shoppingList.count
...
//: Itération
for item in shoppingList // foreach
{
    item
}
...
var monTableau = (0...10).map { $0*$0 } // Instancie avec un multiplicateur
monTableau
