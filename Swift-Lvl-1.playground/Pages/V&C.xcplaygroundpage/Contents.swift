...
// ICI
let monAge: Int = 23 // Type implicite ET explicite
let monNom: String = "Vincent"
let monPoids: Float = 65.1 // Typage nécessaire car sinon `monPoids` est un Double
print("Salut, je suis \(monNom) j'ai \(monAge) ans, je pèse \(monPoids) kg.")

print("Salut, je suis \("Vincent") j'ai \(23) ans, je pèse \(Float(65.1)) kg.") // Equivalent -> Float(x) instancie un Float avec `x` comme valeur

/*
 * let monFloat: Float = 42.2
 * let monFloat = Float(42.2)
 */
//: ---
//: ## Les commentaires
...
/*
 * On ne peut pas décrémenter un UInt en dessous de 0 (problème de mémoire)
 */
...
// Pas de minimum, ni maximum pour les Float et Double
